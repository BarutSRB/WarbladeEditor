...
def _field_contract() -> dict[str, Any]:
    return {
        "confidence_scale": {
            ...
            "unknown": "No semantic label is asserted; the raw value is retained.",
        },
        "fields": {
            "level_mode_id": {
                "confidence": "proven",
            ...
            "supplemental_spawn_records": {
                ...
                "caveat": "The first word is a count and the second is a resource/type selector; the remaining exact semantics are unresolved.",
            },
            "entry_origin_x": {
                "confidence": "proven",
